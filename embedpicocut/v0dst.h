...
// Fri Sep 12 02:17:21 2014 by ROOT version 5.22/00
// from TTree McV0PicoDst/McV0PicoDst from StMcV0Maker
// found on file: /star/u/zhux/ucla/bes/embedpico/7/k0sfp_300_325.pico.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           nmcv0;
   Int_t           nv0;
   Float_t         mcv0pt[500];   //[nmcv0]
   Float_t         mcv0px[500];   //[nmcv0]
   Float_t         mcv0py[500];   //[nmcv0]
   Float_t         mcv0pz[500];   //[nmcv0]
   Float_t         mcv0rapidity[500];   //[nmcv0]
   Int_t           mcv0id[500];   //[nmcv0]
   Float_t         mcv0x[500];   //[nmcv0]
   Float_t         mcv0y[500];   //[nmcv0]
   Float_t         mcv0z[500];   //[nmcv0]
   Int_t           v0mcid[500];   //[nv0]
   Int_t           v0ximcid[500];   //[nv0]
   Int_t           v0mcstverid[500];   //[nv0]
   Float_t         v0mass[500];   //[nv0]
   Float_t         v0pt[500];   //[nv0]
   Float_t         v0rapidity[500];   //[nv0]
   Float_t         v0eta[500];   //[nv0]
   Float_t         v0x[500];   //[nv0]
   Float_t         v0y[500];   //[nv0]
   Float_t         v0z[500];   //[nv0]
   Float_t         v0px[500];   //[nv0]
   Float_t         v0py[500];   //[nv0]
   Float_t         v0pz[500];   //[nv0]
   Float_t         v0declen[500];   //[nv0]
   Float_t         v0dca[500];   //[nv0]
   Float_t         v0dca2d[500];   //[nv0]
   Int_t           dau1id[500];   //[nv0]
   Int_t           dau2id[500];   //[nv0]
   Float_t         dau1dca[500];   //[nv0]
   Float_t         dau1dca2d[500];   //[nv0]
   Int_t           dau1nhits[500];   //[nv0]
   Int_t           dau1nhitsdedx[500];   //[nv0]
   Int_t           dau1nhitsposs[500];   //[nv0]
   Float_t         dau1dedx[500];   //[nv0]
   Float_t         dau1nsigma[500];   //[nv0]
   Float_t         dau1pt[500];   //[nv0]
   Float_t         dau1px[500];   //[nv0]
   Float_t         dau1py[500];   //[nv0]
   Float_t         dau1pz[500];   //[nv0]
   Int_t           dau1tpc[500];   //[nv0]
   Int_t           dau1ssd[500];   //[nv0]
   Int_t           dau1svt[500];   //[nv0]
   Int_t           dau1ncommhits[500];   //[nv0]
   Float_t         dau2dca[500];   //[nv0]
   Float_t         dau2dca2d[500];   //[nv0]
   Int_t           dau2nhits[500];   //[nv0]
   Int_t           dau2nhitsdedx[500];   //[nv0]
   Int_t           dau2nhitsposs[500];   //[nv0]
   Float_t         dau2dedx[500];   //[nv0]
   Float_t         dau2nsigma[500];   //[nv0]
   Float_t         dau2pt[500];   //[nv0]
   Float_t         dau2px[500];   //[nv0]
   Float_t         dau2py[500];   //[nv0]
   Float_t         dau2pz[500];   //[nv0]
   Int_t           dau2tpc[500];   //[nv0]
   Int_t           dau2ssd[500];   //[nv0]
   Int_t           dau2svt[500];   //[nv0]
   Int_t           dau2ncommhits[500];   //[nv0]
   Float_t         dca1to2[500];   //[nv0]

   // List of branches
   TBranch        *b_runnumber;   //!
   TBranch        *b_evtnumber;   //!
   TBranch        *b_nrefmult;   //!
   TBranch        *b_nrefmultembed;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/star/u/zhux/ucla/bes/embedpico/7/k0sfp_300_325.pico.root");
      if (!f) {
         f = new TFile("/star/u/zhux/ucla/bes/embedpico/7/k0sfp_300_325.pico.root");
      }
...
void v0dst::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nrefmultembed", &nrefmultembed, &b_nrefmultembed);
   ...
   fChain->SetBranchAddress("v0ximcid", v0ximcid, &b_v0ximcid);
   ...
   fChain->SetBranchAddress("dau1ncommhits", dau1ncommhits, &b_dau1ncommhits);
   ...
   fChain->SetBranchAddress("dau2ncommhits", dau2ncommhits, &b_dau2ncommhits);
