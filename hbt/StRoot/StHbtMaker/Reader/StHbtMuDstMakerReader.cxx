...
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
Int_t StHbtMuDstMakerReader::numberOfPrimaryVertices(){
    
    return mMuDst->numberOfPrimaryVertices();
}
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
StHbtEvent* StHbtMuDstMakerReader::ReturnHbtEvent(Int_t vertexIndex){
    mMuDst->setVertexIndex(vertexIndex);
    return ReturnHbtEvent();
