...
Double_t StRefMultCorr::getWeight() const
{
  ...
  //this scale factor is only valid for VpdMB5, so you don't need to apply it in VPD30 and VpdNoVtx
//  Weight *= scale ;
...
const Char_t* StRefMultCorr::getTable() const
{
  if ( mName.CompareTo("refmult", TString::kIgnoreCase) == 0 ) {
    return "/Users/DavidTlustyRice/Muons/DiMuons2014/dcaGeometry/include/StRefMultCorr/Centrality_def_refmult.txt";
  }
  else if ( mName.CompareTo("refmult2", TString::kIgnoreCase) == 0 ) {
    return "/Users/DavidTlustyRice/Muons/DiMuons2014/dcaGeometry/include/StRefMultCorr/Centrality_def_refmult2.txt";
  }
  else if ( mName.CompareTo("refmult3", TString::kIgnoreCase) == 0 ) {
    return "/Users/DavidTlustyRice/Muons/DiMuons2014/dcaGeometry/include/StRefMultCorr/Centrality_def_refmult3.txt";
  }
  else if ( mName.CompareTo("toftray", TString::kIgnoreCase) == 0 ) {
    return "/Users/DavidTlustyRice/Muons/DiMuons2014/dcaGeometry/include/StRefMultCorr/Centrality_def_toftray.txt";
  }
  else if ( mName.CompareTo("grefmult", TString::kIgnoreCase) == 0 ) {
    return "/Users/DavidTlustyRice/Muons/DiMuons2014/dcaGeometry/include/StRefMultCorr/Centrality_def_grefmult.txt";
  }
  else{
