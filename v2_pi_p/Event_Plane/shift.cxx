...
//StChain *chain;
void shift(const Char_t *inputFile,float RPOrder, const Char_t *outputFile,char *recfile,float etaA1,float etaA2,float etaA3,float etaA4)
{
	...
	//cout<<"PicoDst declared!"<<endl;
        StMyShiftMaker *anaMaker = new StMyShiftMaker("ana",picoMaker,outputFile,recfile,RPOrder,etaA1,etaA2,etaA3,etaA4);
