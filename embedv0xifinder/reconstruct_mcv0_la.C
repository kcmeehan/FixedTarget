...
void reconstruct_mcv0_la(TString InputFileList, Int_t Nlist, Int_t Block = 50, Int_t nEvents = 0, TString OutputDir = "output/");

void reconstruct_mcv0_la(TString InputFileList, Int_t Nlist, Int_t Block, Int_t nEvents, TString OutputDir) 
{
  // Load libraries
