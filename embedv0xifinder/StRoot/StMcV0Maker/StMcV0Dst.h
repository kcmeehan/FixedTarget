...
struct StMcV0Dst{ 
   ...
   int dau1nhitsdedx[MAX_NUM_McV0];
   int dau1nhitsposs[MAX_NUM_McV0];
   ...
   int dau1ncommhits[MAX_NUM_McV0];
   float dau2dca[MAX_NUM_McV0];
   float dau2dca2d[MAX_NUM_McV0];
   int dau2nhits[MAX_NUM_McV0];
   int dau2nhitsdedx[MAX_NUM_McV0];
   int dau2nhitsposs[MAX_NUM_McV0];
   ...
   int dau2ncommhits[MAX_NUM_McV0];
