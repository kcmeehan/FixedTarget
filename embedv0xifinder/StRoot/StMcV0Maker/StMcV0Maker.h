...
//  };
  ...
  //files related
  TString       mMoreTagsFileName ;         // store the run #, evt # and nrefmult from data MuDst
 ...
 public:
  ...
  void setMoreTagsFileName(TString name) {mMoreTagsFileName = name;} //set the name of output file for histograms
  ...
  void setSecondaryV0(bool secnd) {mSecondaryV0 = secnd;} //set whether the v0 is secondary, default is false
