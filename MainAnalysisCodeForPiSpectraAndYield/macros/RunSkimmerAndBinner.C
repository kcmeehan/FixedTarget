...
void RunSkimmerAndBinner(TString inputFile, TString starLibrary, Long64_t nEvents=-1, TString outputFile="", Double_t energy=0, TString eventConfig=""){
  ...
  skimmerAndBinner(inputFile,starLibrary,nEvents,outputFile,energy,eventConfig);
