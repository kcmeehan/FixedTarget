...
class FxtMaker : public StMaker {
  private:
    ...
    TH1D *hist_pt_deuteron;
    TH1D *hist_eta_deuteron;
    TH1D *hist_y_deuteron;
    TH2D *hist_pt_y_deuteron;
    TH1D *hist_phi_deuteron;
    TH1D *hist_trackmult_deuteron;
    TH2D *hist_dEdx_deuteron;
    TH2D *hist_beta_deuteron;
    TH2D *hist_mass_deuteron;
    ...
    TProfile3D *profile3D_deuteron_v1;
    TH1D *deuteron_v1_cent[Ncentralities];
    TH1D *deuteron_v1_10_30_averaged;
    ...
    //TH2D *hist_pt_rap_proton;
    //TH2D *hist_pt_rap_pionPlus;
    //TH2D *hist_pt_rap_pionMinus;
    //TH2D *hist_pt_rap_kaonPlus;
    //TH2D *hist_pt_rap_kaonMinus;
  public:
