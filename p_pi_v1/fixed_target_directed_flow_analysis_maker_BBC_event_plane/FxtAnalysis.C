Int_t FxtAnalysis(Int_t nEvents, Int_t nFiles, TString InputFileList, /*TString OutputDir,*/ TString JobIdName, Double_t testParameter1, Double_t testParameter2)
{
  // Load libraries
  ...
  FxtMaker* doAnalysis = new FxtMaker(muDstMaker,JobIdName,nEvents,testParameter1,testParameter2);
