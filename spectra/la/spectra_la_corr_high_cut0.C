{
   ...
   TString ifile = "output/weight_la_"+cuttag+"_high_fp.txt";
   TString iexpfile = "output/weight_la_"+cuttag+"_high_exp.txt";
   ...
   Double_t fitparms_cut4[50]={0.0842367,0.117156,0.589423,0.124801,4.25605,0.130473,47.3256,0.132487,807.506,0.129355,26662.6,0.118335};
   ...
   TString oname = "auau"+Ecm+"_la_spectra_"+cuttag+"_high.txt";
   ...
   TString ofigname = "auau"+Ecm+"_la_spectra_"+cuttag+"_high.pdf";
   c1->SaveAs(ofigname);
   TString ointyieldname = "auau"+Ecm+"_la_cent_"+cuttag+"_high.txt";
   ...
   TString ofitparname = "auau"+Ecm+"_la_fit_"+cuttag+"_high.txt";
