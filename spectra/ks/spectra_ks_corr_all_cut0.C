{
   ...
   TString lowname = "auau"+Ecm+"_ks_spectra_"+cuttag+"_low.txt";
   TString highname = "auau"+Ecm+"_ks_spectra_"+cuttag+"_high.txt";
   ...
   TString oname = "auau"+Ecm+"_ks_spectra_"+cuttag+".txt";
   ...
   TString lowname = "auau"+Ecm+"_ks_cent_"+cuttag+"_low.txt";
   TString highname = "auau"+Ecm+"_ks_cent_"+cuttag+"_high.txt";
   ...
   TString ofigname = "auau"+Ecm+"_ks_spectra_"+cuttag+".pdf";
   c1->SaveAs(ofigname);
   TString ointyieldname = "auau"+Ecm+"_ks_cent_"+cuttag+".txt";
   ...
   TString ofitparname = "auau"+Ecm+"_ks_fit_"+cuttag+"_low.txt";
