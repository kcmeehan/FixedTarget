{
   ...
   TString ifile = "output/weight_k0s_"+cuttag+"_low_fp.txt";
   TString iexpfile = "output/weight_k0s_"+cuttag+"_low_exp.txt";
   ...
   TString oname = "auau"+Ecm+"_ks_spectra_"+cuttag+"_low.txt";
   ...
   TString ofigname = "auau"+Ecm+"_ks_spectra_"+cuttag+"_low.pdf";
   c1->SaveAs(ofigname);
   TString ointyieldname = "auau"+Ecm+"_ks_cent_"+cuttag+"_low.txt";
